...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:4a0e0e,100:1a0505&height=130&section=header&text=Santiago%20Franco&fontSize=36&fontColor=ece5e5&fontAlignY=60&animation=fadeIn" width="100%"/>

### 🎓 Computer Engineering Student · About to finish my thesis

*Passionate about data, patterns, and everything that can be discovered within them.*
...
santiago = {
    ...
    "location":   "Paraguay 🇵🇾",
    "education":  "Computer Engineering (thesis in progress)",
    "focus":      ["Data Science", "Data Analysis", "ML"],
    "learning":   "Ruby 💎 (for fun)",
    "status":     "Turning data into decisions 📊"
}
```
